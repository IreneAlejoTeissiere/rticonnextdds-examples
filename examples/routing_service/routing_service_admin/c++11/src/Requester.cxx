...
void send(CommandRequest& request, rti::request::Requester<RTI::Service::Admin::CommandRequest, RTI::Service::Admin::CommandReply>& requester){
        ...
        CommandReply reply = requester.receive_replies(
                Duration(WAIT_TIMEOUT_SEC_MAX))[0];
...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        rti::request::Requester<RTI::Service::Admin::CommandRequest, RTI::Service::Admin::CommandReply> requester(requester_params);
